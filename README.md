...
```javascript
array2buffer = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/buffer-from-array@v0.2.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/buffer-from-array@v0.2.0-umd/browser.js"></script>
```
